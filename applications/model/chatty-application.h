...
#ifndef CHATTY_APPLICATION_H
#define CHATTY_APPLICATION_H
 ...
 * \defgroup bulksend ChattyApplication
 *
 ...
 *
 */
class ChattyApplication : public Application
{
public:
  /**
...
private:
  ...
  EventId m_sendEvent2; //!< Event to send the next packet
