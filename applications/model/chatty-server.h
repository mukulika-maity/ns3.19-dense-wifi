...
#ifndef CHATTY_SERVER_H
#define CHATTY_SERVER_H
 ...
 * \defgroup ChattyServer ChattyServer
 *
 * This application was written to complement OnOffApplication, but it
 * is more general so a ChattyServer name was selected.  Functionally it is
 ...
 */
class ChattyServer : public Application
{
public:
  /**
...
private:
  ...
  void Send (Ptr<Socket> socket,int size);
 //void SendData (void);
  /**
 ...
 /* class Client{
  ...
  std::map < Ptr<Socket>, uint32_t> client_list;
  std::map < Ptr<Socket>, bool> client_connected;
