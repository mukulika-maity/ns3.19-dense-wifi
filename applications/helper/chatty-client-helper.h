...
#ifndef CHATTY_CLIENT_HELPER_H
#define CHATTY_CLIENT_HELPER_H
 ...
 * on a set of nodes.
 */
class ChattyClientHelper
{
public:
  /**
   * Create an ChattyClientHelper to make it easier to work with BulkSendApplications
   *
   ...
   *        to.
   */
  ChattyClientHelper (std::string protocol, Address address);
