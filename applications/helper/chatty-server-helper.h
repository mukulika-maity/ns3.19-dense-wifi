 ...
 */
#ifndef CHATTY_SERVER_HELPER_H
#define CHATTY_SERVER_HELPER_H
 ...
 * on a set of nodes.
 */
class ChattyServerHelper
{
public:
  /**
   * Create a ChattyServerHelper to make it easier to work with PacketSinkApplications
   *
   ...
   *
   */
  ChattyServerHelper (std::string protocol, Address address);
