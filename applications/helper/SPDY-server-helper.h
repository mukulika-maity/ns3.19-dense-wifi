 ...
 */
#ifndef SPDY_SERVER_HELPER_H
#define SPDY_SERVER_HELPER_H
 ...
 * on a set of nodes.
 */
class SPDYServerHelper
{
public:
  /**
   * Create a SPDYServerHelper to make it easier to work with PacketSinkApplications
   *
   ...
   *
   */
  SPDYServerHelper (std::string protocol, Address address);
