...
#ifndef CHATTY_APPLICATION_HELPER_H
#define CHATTY_APPLICATION_HELPER_H
 ...
 * on a set of nodes.
 */
class ChattyApplicationHelper
{
public:
  /**
   * Create an ChattyApplicationHelper to make it easier to work with BulkSendApplications
   *
   ...
   *        to.
   */
  ChattyApplicationHelper (std::string protocol, Address address);
