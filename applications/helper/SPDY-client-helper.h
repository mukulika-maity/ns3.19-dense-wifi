...
#ifndef SPDY_CLIENT_HELPER_H
#define SPDY_CLIENT_HELPER_H
 ...
 * on a set of nodes.
 */
class SPDYClientHelper
{
public:
  /**
   * Create an SPDYClientHelper to make it easier to work with BulkSendApplications
   *
   ...
   *        to.
   */
  SPDYClientHelper (std::string protocol, Address address);
