 ...
 */
#ifndef BULK_SERVER_HELPER_H
#define BULK_SERVER_HELPER_H
...
public:
  /**
   * Create a BulkServerHelper to make it easier to work with PacketSinkApplications
   *
   ...
   *
   */
  BulkServerHelper (std::string protocol, Address address);
