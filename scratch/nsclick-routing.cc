...
//
  ...
  clickinternet.SetClickFile (n.Get (0), "scratch/nsclick-routing-node0.click");
 // clickinternet.SetClickFile (n.Get (1), "scratch/nsclick-ip-router.click");
  //clickinternet.SetClickFile (n.Get (2), "scratch/nsclick-routing-node2.click");
  ...
  clickinternet.Install (n.Get(0));
  InternetStackHelper stack;
  	stack.Install (n.Get(1));
  	stack.Install (n.Get(2));
...
//
  ...
  BulkSendHelper source ("ns3::TcpSocketFactory",
  		...
  		source.SetAttribute ("MaxBytes", UintegerValue (2048));
  		...
  		ApplicationContainer sinkApps = sink.Install (n.Get (2));
