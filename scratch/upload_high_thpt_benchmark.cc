	  ...
	  SeedManager::SetSeed (1);
        ...
        //std::cout << "i= " << i << std::endl;
         BulkSendHelper source ("ns3::TcpSocketFactory",
                         InetSocketAddress (csmaInterfaces.GetAddress (nCsma-1), port));
...
//
   ...
   if (tracing)
    {
      ...
      //csma.EnablePcapAll ("analysis/traffic_model/11g_mod/uplod_11g", false);
  ...
  phy.EnablePcap ("analysis/traffic_model/11g_mod/upload_11g", staDevices.Get(0));
  phy.SetPcapDataLinkType(YansWifiPhyHelper::DLT_IEEE802_11_RADIO);

  	phy.EnablePcap ("analysis/traffic_model/11g_mod/ap_upload_11g", apDevices.Get (0));
