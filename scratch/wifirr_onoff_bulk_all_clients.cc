...
main (int argc, char *argv[])
{
	...
	if (tracing)
	{
		...
		//csma.EnableAsciiAll (ascii.CreateFileStream ("analysis/traffic_model/11g_mod/base_case_on.tr"));
		csma.EnablePcapAll ("analysis/traffic_model/11g_mod/base_case_on", false);
  ...
  clientApps.Stop (Seconds (10.0));*/
	...
	//phy.EnablePcap ("analysis/traffic_model/11g_mod/client_base_case", staDevices.Get(5));
	phy.EnablePcap ("analysis/traffic_model/11g_mod/ap_base_case_on", apDevices.Get (0));
	AsciiTraceHelper ascii;
			//csma.EnableAsciiAll (ascii.CreateFileStream ("analysis/traffic_model/11g_mod/csma_ldsu.tr"));
	csma.EnablePcapAll ("analysis/traffic_model/11g_mod/final_results/cbr_base", false);
			//Ptr<OutputStreamWrapper> stream = ascii.CreateFileStream(buff_tr_file_name.c_str());
			//Simulator::Schedule(Seconds(0.00002), &BuffTracer, stream,apDevices);
	//phy.EnableAscii(ascii.CreateFileStream ("analysis/traffic_model/11g_mod/ap_sol_minstrel_test.tr"),apDevices.Get (0));
	//phy.EnableAscii(ascii.CreateFileStream ("analysis/traffic_model/11g_mod/ap_mac_sol_minstrel_test.tr"),wifiApNode);
