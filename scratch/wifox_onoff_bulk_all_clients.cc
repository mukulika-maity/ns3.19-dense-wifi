...
main (int argc, char *argv[])
{
	...
	if (tracing)
	{
		...
		csma.EnablePcapAll ("analysis/traffic_model/11g_mod/final_results/sol_minstrel_wifox", false);
  ...
  clientApps.Stop (Seconds (10.0));*/
	...
	phy.EnablePcap ("analysis/traffic_model/11g_mod/final_results/ap_sol_minstrel_wifox", apDevices.Get (0));
