...
private:
  ...
  RandomStream *m_rng;
  std::list<Mac48Address> m_clients;
  std::list<Mac48Address> active_clients;
  typedef std::list<Mac48Address>::iterator clientsI;
  std::list<Mac48Address>::iterator schedI;
  Time schedTime;
  uint32_t numClients;
