...
WifiMac::Configure80211g (void)
{
  ...
  SetSlot (MicroSeconds (9));
  SetEifsNoDifs (MicroSeconds (10 + 304));
  SetPifs (MicroSeconds (10 + 9));
  SetCtsTimeout (MicroSeconds (10 + 304 + 9 + GetDefaultMaxPropagationDelay ().GetMicroSeconds () * 2));
  SetAckTimeout (MicroSeconds (10 + 304 + 9 + GetDefaultMaxPropagationDelay ().GetMicroSeconds () * 2));
}
